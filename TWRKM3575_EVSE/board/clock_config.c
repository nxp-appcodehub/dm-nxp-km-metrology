...
const mcg_config_t mcgConfig_BOARD_BootClockRUNBat =
    {
...
void BOARD_BootClockRUNBat(void)
{
    /* Use RTC_CLKIN input clock directly. */
    CLOCK_SetXtal32Freq(32768U);
    /* Set the system clock dividers in SIM to safe value. */
    ...
    CLOCK_BootToBlpiMode(mcgConfig_BOARD_BootClockRUNBat.fcrdiv,
                         mcgConfig_BOARD_BootClockRUNBat.ircs,
                         mcgConfig_BOARD_BootClockRUNBat.irclkEnableMode);
    /* Select the MCG external reference clock. */
    CLOCK_SetExternalRefClkConfig(mcgConfig_BOARD_BootClockRUNBat.oscsel);
    /* Set the clock configuration in SIM module. */
    CLOCK_SetSimConfig(&simConfig_BOARD_BootClockRUN);
    /* Set SystemCoreClock variable. */
